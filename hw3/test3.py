...
df2 = pd.read_csv('exp/MsPacman_dqn_sd1_20260307_024000/log.csv')
...
plt.plot(df2[x_col], df2[y_col2], label='Train_EpisodeReturn', linewidth=1.5)
# 4. Add formatting
