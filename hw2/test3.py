...
df1 = pd.read_csv('exp/LunarLander-v2_lunar_lander_lambda0_sd1/log.csv')
df2 = pd.read_csv('exp/LunarLander-v2_lunar_lander_lambda0.95_sd1/log.csv')
df3 = pd.read_csv('exp/LunarLander-v2_lunar_lander_lambda0.98_sd1/log.csv')
df4 = pd.read_csv('exp/LunarLander-v2_lunar_lander_lambda0.99_sd1/log.csv')
df5 = pd.read_csv('exp/LunarLander-v2_lunar_lander_lambda1_sd1/log.csv')
